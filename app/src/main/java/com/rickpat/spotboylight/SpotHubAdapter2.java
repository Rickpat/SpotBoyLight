...
public class SpotHubAdapter2 extends RecyclerView.Adapter<SpotHubAdapter2.ViewHolder> {
    ...
    public SpotHubAdapter2(List<SpotLocal> spotList , Activity activity) {
    ...
    @Override
    public SpotHubAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
